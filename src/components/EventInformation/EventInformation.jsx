      ...
      <div className="event-information">
        ...
        <div className="description-info">
          ...
          <p>
            ...
            risus. Laoreet condimentum sodales mauris feugiat. Diam sit ultrices
            integer sodales quam eget nullam id euismod. Vivamus iaculis quis
            tristique pulvinar consectetur arcu. Elementum venenatis suspendisse
            cursus nisl. Amet quis lacus tortor odio purus arcu. Molestie libero
            aliquam magnis at cras amet amet massa elementum. Et tincidunt
            semper tellus erat sit leo molestie. Diam eu libero curabitur lectus
            tellus. Facilisi morbi enim leo purus adipiscing. Varius euismod
            adipiscing fermentum ac pretium. Diam ultricies aenean viverra sed
            odio turpis netus. Pellentesque ridiculus ornare a sed. Commodo eu
            blandit id auctor non non eu. At quis cursus in libero neque
            facilisis id. Scelerisque in faucibus arcu neque scelerisque.
            Malesuada euismod montes tempus purus sed tristique vestibulum eget.
            Arcu integer purus tincidunt vulputate cras. Id aliquet dolor quis
            ultrices. Turpis amet donec odio odio tincidunt convallis placerat.
            Eget sodales in tincidunt fringilla nibh urna cum.
          </p>
        </div>
      </div>
    )
